---
title: canvas account-content-migrations migrators
---

## canvas account-content-migrations migrators

List available migrator types for an account

```
canvas account-content-migrations migrators <account-id> [flags]
```
