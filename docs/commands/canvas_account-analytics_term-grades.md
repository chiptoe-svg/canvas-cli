---
title: canvas account-analytics term-grades
---

## canvas account-analytics term-grades

Get grade analytics for an account term

```
canvas account-analytics term-grades <account-id> <term-id> [flags]
```

### Options

```
  -h, --help   help for term-grades
```
