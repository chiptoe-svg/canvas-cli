---
title: canvas user-features get-flag
---

## canvas user-features get-flag

Get a feature flag for a user

### Synopsis

Get the state of a specific feature flag for a user.
...
```
canvas user-features get-flag [flags]
```
