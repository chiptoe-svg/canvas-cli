---
title: canvas favorites groups reset
---

## canvas favorites groups reset

Reset favorite groups to defaults

### Synopsis

Reset all favorite groups to the system defaults.
...
```
canvas favorites groups reset [flags]
```
