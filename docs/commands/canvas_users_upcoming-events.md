---
title: canvas users upcoming-events
---
...
Get upcoming events for the currently authenticated user.
...
```
canvas users upcoming-events [flags]
```

### Options

```
  -h, --help   help for upcoming-events
```
