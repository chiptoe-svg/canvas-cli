---
title: canvas account-features delete-flag
---

## canvas account-features delete-flag

Remove a feature flag override for an account

```
canvas account-features delete-flag <account-id> <feature> [flags]
```
