---
title: canvas jwts create
---

## canvas jwts create

Create a new Canvas JWT

### Synopsis

Create a new Canvas JWT for the current user.
...
```
  -h, --help              help for create
      --workflow string   Workflow state to embed in the JWT
```
