---
title: canvas csp-settings lock
---

## canvas csp-settings lock

Lock or unlock CSP settings for sub-accounts

```
canvas csp-settings lock <account-id> [flags]
```
...
```
  -h, --help     help for lock
      --locked   Lock CSP settings for sub-accounts
```
