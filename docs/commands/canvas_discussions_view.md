---
title: canvas discussions view
---

## canvas discussions view

Get the full threaded view of a discussion topic

### Synopsis

Get the full cached view of a discussion topic, including all entries and participants.
...
```
canvas discussions view <topic-id> [flags]
```
