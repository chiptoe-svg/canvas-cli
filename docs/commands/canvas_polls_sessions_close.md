---
title: canvas polls sessions close
---

## canvas polls sessions close

Close a poll session

### Synopsis

Close a poll session to stop accepting submissions.
...
```
canvas polls sessions close <session-id> [flags]
```
