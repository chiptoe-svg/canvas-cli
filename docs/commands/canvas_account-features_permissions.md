---
title: canvas account-features permissions
---

## canvas account-features permissions

Get permissions for the current user in an account

```
canvas account-features permissions <account-id> [flags]
```
...
```
  -h, --help                  help for permissions
      --permissions strings   Comma-separated list of permissions to check
```
