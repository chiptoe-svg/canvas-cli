---
title: canvas course-settings permissions
---

## canvas course-settings permissions

Get permissions for the current user in a course

```
canvas course-settings permissions [flags]
```
