---
title: canvas auth-providers create
---

## canvas auth-providers create

Create a new authentication provider

```
canvas auth-providers create <account-id> [flags]
```

### Options

```
      --auth-type string         Authentication type (saml, ldap, google, etc.)
      --client-id string         OAuth client ID
      --client-secret string     OAuth client secret
  -h, --help                     help for create
      --login-attribute string   Login attribute
```
