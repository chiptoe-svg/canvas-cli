---
title: canvas temporary-enrollment-pairings get
---

## canvas temporary-enrollment-pairings get

Get a specific temporary enrollment pairing

```
canvas temporary-enrollment-pairings get <account-id> <id> [flags]
```
