---
title: canvas quizzes groups get
---

## canvas quizzes groups get

Get a quiz question group

### Synopsis

Get details of a specific quiz question group.
...
```
canvas quizzes groups get <group-id> [flags]
```
