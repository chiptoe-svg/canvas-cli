---
title: canvas discussions update-entry
---

## canvas discussions update-entry

Update a discussion entry

### Synopsis

Update the message of an existing discussion entry.
...
```
canvas discussions update-entry <topic-id> <entry-id> [flags]
```
...
```
  ...
  -h, --help             help for update-entry
  -m, --message string   Updated message content (required)
```
