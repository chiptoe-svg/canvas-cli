---
title: canvas grading-period-sets list-periods
---

## canvas grading-period-sets list-periods

List grading periods for an account

```
canvas grading-period-sets list-periods <account-id> [flags]
```
