---
title: canvas account-features list-enabled
---

## canvas account-features list-enabled

List enabled features for an account

```
canvas account-features list-enabled <account-id> [flags]
```
