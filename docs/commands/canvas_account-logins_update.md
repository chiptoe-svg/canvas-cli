---
title: canvas account-logins update
---

## canvas account-logins update

Update a login in an account

```
canvas account-logins update <account-id> <login-id> [flags]
```
...
```
  -h, --help               help for update
      ...
      --unique-id string   New unique ID / username
```
