---
title: canvas conferences
---

## canvas conferences

List Canvas web conferences

### Synopsis

List web conferences (BigBlueButton, Zoom, etc.) for the current user,
a course, or a group.
...
* [canvas conferences list](canvas_conferences_list.md)	 - List web conferences
