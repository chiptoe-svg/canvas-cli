---
title: canvas account-analytics completed-statistics
---

## canvas account-analytics completed-statistics

Get statistics for completed courses in an account

```
canvas account-analytics completed-statistics <account-id> [flags]
```

### Options

```
  -h, --help   help for completed-statistics
```
