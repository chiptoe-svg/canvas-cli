---
title: canvas groups content-exports list
---

## canvas groups content-exports list

List content exports for a group

```
canvas groups content-exports list <group-id> [flags]
```
