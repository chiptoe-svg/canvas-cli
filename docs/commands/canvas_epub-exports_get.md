---
title: canvas epub-exports get
---

## canvas epub-exports get

Get an ePub export by ID

### Synopsis

Retrieve the status and details of an ePub export.
...
```
canvas epub-exports get <id> [flags]
```
