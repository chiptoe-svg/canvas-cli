---
title: canvas error-reports
---

## canvas error-reports

Submit Canvas error reports

### Synopsis

Submit error reports to Canvas administrators.
...
* [canvas error-reports create](canvas_error-reports_create.md)	 - Submit an error report
