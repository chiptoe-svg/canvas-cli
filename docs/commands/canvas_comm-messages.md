---
title: canvas comm-messages
---

## canvas comm-messages

List Canvas communication messages

### Synopsis

List communication messages that have been sent to a user.
...
* [canvas comm-messages list](canvas_comm-messages_list.md)	 - List communication messages
