...
View Canvas brand/theme variables

### Synopsis

Retrieve Canvas branding and theme variables (colors, logos, etc.).
...
* [canvas brand get](canvas_brand_get.md)	 - Get brand variables
