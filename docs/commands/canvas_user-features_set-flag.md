---
title: canvas user-features set-flag
---

## canvas user-features set-flag

Set a feature flag for a user

### Synopsis

Set the state of a feature flag for a user.
...
```
canvas user-features set-flag [flags]
```
...
```
  ...
  -h, --help             help for set-flag
      --state string     Feature state: on, off, allowed (required)
