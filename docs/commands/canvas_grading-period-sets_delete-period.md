---
title: canvas grading-period-sets delete-period
---

## canvas grading-period-sets delete-period

Delete a grading period

```
canvas grading-period-sets delete-period <account-id> <id> [flags]
```

### Options

```
  -h, --help   help for delete-period
```
