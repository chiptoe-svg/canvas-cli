---
title: canvas account-features get-flag
---

## canvas account-features get-flag

Get the feature flag for a specific feature

```
canvas account-features get-flag <account-id> <feature> [flags]
```

### Options

```
  -h, --help   help for get-flag
```
