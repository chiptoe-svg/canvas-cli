---
title: canvas polls sessions list-opened
---

## canvas polls sessions list-opened

List all open poll sessions

### Synopsis

List all currently open poll sessions across all polls.
...
```
canvas polls sessions list-opened [flags]
```

### Options

```
  -h, --help   help for list-opened
```
