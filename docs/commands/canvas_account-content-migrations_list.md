---
title: canvas account-content-migrations list
---

## canvas account-content-migrations list

List content migrations for an account

```
canvas account-content-migrations list <account-id> [flags]
```
