---
title: canvas discussions mark-entry-unread
---

## canvas discussions mark-entry-unread

Mark a discussion entry as unread

### Synopsis

Mark a specific discussion entry as unread.
...
```
canvas discussions mark-entry-unread <topic-id> <entry-id> [flags]
```
...
```
  ...
  -h, --help            help for mark-entry-unread
```
