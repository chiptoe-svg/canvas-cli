---
title: canvas temporary-enrollment-pairings create
---

## canvas temporary-enrollment-pairings create

Create a temporary enrollment pairing for an account

```
canvas temporary-enrollment-pairings create <account-id> [flags]
```

### Options

```
      --enrollment-state string   Starting enrollment state (invited, active)
  -h, --help                      help for create
      --role-id int               Role ID for the temporary enrollment
```
