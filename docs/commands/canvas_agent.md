...
Helpers for running canvas under an AI agent

### Synopsis

Helpers for running canvas under an AI agent (Claude Code, Codex, OpenCode, …).
...
* [canvas agent guard](canvas_agent_guard.md)	 - Generate agent-safety config that blocks destructive canvas operations
