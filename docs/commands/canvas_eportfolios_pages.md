---
title: canvas eportfolios pages
---

## canvas eportfolios pages

List pages in an ePortfolio

### Synopsis

List all pages within a specific ePortfolio.
...
```
canvas eportfolios pages <eportfolio-id> [flags]
```
