---
title: canvas media objects tracks
---

## canvas media objects tracks

List media tracks for a media object

### Synopsis

List the caption/subtitle tracks for a media object.
...
```
canvas media objects tracks <media-id> [flags]
```
