---
title: canvas rubric-associations update
---

## canvas rubric-associations update

Update a rubric association

```
canvas rubric-associations update <association-id> [flags]
```
...
```
  ...
  -h, --help                  help for update
      --purpose string        Purpose (grading, bookmark)
      --purpose-type-id int   Purpose type ID
      --rubric-id int         Rubric ID
```
