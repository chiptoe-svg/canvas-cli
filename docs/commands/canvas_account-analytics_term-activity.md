---
title: canvas account-analytics term-activity
---

## canvas account-analytics term-activity

Get activity analytics for an account term

```
canvas account-analytics term-activity <account-id> <term-id> [flags]
```

### Options

```
  -h, --help   help for term-activity
```
