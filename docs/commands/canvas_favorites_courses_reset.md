---
title: canvas favorites courses reset
---

## canvas favorites courses reset

Reset favorite courses to defaults

### Synopsis

Reset all favorite courses to the system defaults.
...
```
canvas favorites courses reset [flags]
```
