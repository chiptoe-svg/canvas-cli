---
title: canvas grading-period-sets create
---

## canvas grading-period-sets create

Create a grading period set

```
canvas grading-period-sets create <account-id> [flags]
```
...
```
  -h, --help           help for create
      --title string   Title of the grading period set (required)
      --weighted       Use weighted grading periods
```
