...
Manage Canvas collaborations

### Synopsis

List collaborations (Google Docs, etc.) for courses and groups, and
...
```
  -h, --help   help for collaborations
```
...
* [canvas collaborations list](canvas_collaborations_list.md)	 - List collaborations
* [canvas collaborations members](canvas_collaborations_members.md)	 - List collaboration members
