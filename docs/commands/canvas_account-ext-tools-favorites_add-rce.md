---
title: canvas account-ext-tools-favorites add-rce
---

## canvas account-ext-tools-favorites add-rce

Add an external tool as an RCE favorite for an account

```
canvas account-ext-tools-favorites add-rce <account-id> <tool-id> [flags]
```

### Options

```
  -h, --help   help for add-rce
```
