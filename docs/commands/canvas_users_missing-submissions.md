---
title: canvas users missing-submissions
---

## canvas users missing-submissions

Get missing submissions for a user

### Synopsis

Get assignments with missing submissions for a user.
...
```
canvas users missing-submissions <user-id> [flags]
```

### Options

```
  -h, --help   help for missing-submissions
```
