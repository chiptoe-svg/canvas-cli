---
title: canvas account-content-migrations get
---

## canvas account-content-migrations get

Get a content migration for an account

```
canvas account-content-migrations get <account-id> <migration-id> [flags]
```
