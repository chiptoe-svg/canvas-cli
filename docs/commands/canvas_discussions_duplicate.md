---
title: canvas discussions duplicate
---

## canvas discussions duplicate

Duplicate a discussion topic

### Synopsis

Duplicate a discussion topic in a course or group.
...
```
canvas discussions duplicate <topic-id> [flags]
```
