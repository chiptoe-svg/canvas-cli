---
title: canvas developer-keys bind
---

## canvas developer-keys bind

Create an account binding for a developer key

```
canvas developer-keys bind <account-id> <developer-key-id> [flags]
```
...
```
  -h, --help                    help for bind
      --workflow-state string   Binding state: "on", "off", or "allow" (required)
```
