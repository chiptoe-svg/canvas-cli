---
title: canvas temporary-enrollment-pairings list
---

## canvas temporary-enrollment-pairings list

List temporary enrollment pairings for an account

```
canvas temporary-enrollment-pairings list <account-id> [flags]
```
