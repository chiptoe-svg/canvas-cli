---
title: canvas content-shares get
---

## canvas content-shares get

Get a specific content share

### Synopsis

Get details of a specific content share.
...
```
canvas content-shares get [flags]
```
...
```
  -h, --help          help for get
      --id int        Content share ID (required)
