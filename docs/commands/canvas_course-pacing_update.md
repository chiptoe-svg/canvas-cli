---
title: canvas course-pacing update
---

## canvas course-pacing update

Update a course pace

```
canvas course-pacing update <pace-id> [flags]
```
...
```
      ...
      --end-date string    Pace end date (YYYY-MM-DD)
      --exclude-weekends   Exclude weekends from pacing
      --hard-end-dates     Use hard end dates
