---
title: canvas account-notifications get
---

## canvas account-notifications get

Get a specific account notification

```
canvas account-notifications get <account-id> <id> [flags]
```
