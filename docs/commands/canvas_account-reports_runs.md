---
title: canvas account-reports runs
---

## canvas account-reports runs

List runs for a specific report type

```
canvas account-reports runs <account-id> <report-name> [flags]
```
