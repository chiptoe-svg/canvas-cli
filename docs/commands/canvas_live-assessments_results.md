---
title: canvas live-assessments results
---

## canvas live-assessments results

List results for a live assessment

```
canvas live-assessments results [flags]
```

### Options

```
      --assessment-id string   Assessment ID (required)
