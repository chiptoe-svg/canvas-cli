---
title: canvas course-nicknames delete
---

## canvas course-nicknames delete

Delete the nickname for a course

### Synopsis

Remove the nickname set for a specific course.
...
```
canvas course-nicknames delete <course-id> [flags]
```
