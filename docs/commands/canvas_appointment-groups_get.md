---
title: canvas appointment-groups get
---

## canvas appointment-groups get

Get an appointment group

### Synopsis

Get details of a specific appointment group.
...
```
canvas appointment-groups get <group-id> [flags]
```
...
```
  -h, --help              help for get
      --include strings   Additional fields: appointments, child_events, all_context_codes
```
