---
title: canvas account-notifications create
---

## canvas account-notifications create

Create a new account notification

```
canvas account-notifications create <account-id> [flags]
```
...
```
  ...
  -h, --help              help for create
      --icon string       Icon type (warning, information, question, error, calendar)
