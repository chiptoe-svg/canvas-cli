---
title: canvas temporary-enrollment-pairings delete
---

## canvas temporary-enrollment-pairings delete

Delete a temporary enrollment pairing

```
canvas temporary-enrollment-pairings delete <account-id> <id> [flags]
```
