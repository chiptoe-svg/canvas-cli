---
title: canvas jwts refresh
---

## canvas jwts refresh

Refresh an existing Canvas JWT

### Synopsis

Refresh an existing Canvas JWT and get a new one.
...
```
  -h, --help           help for refresh
      --token string   Existing JWT to refresh
```
