---
title: canvas course-settings late-policy
---

## canvas course-settings late-policy

Get the late policy for a course

```
canvas course-settings late-policy [flags]
```
