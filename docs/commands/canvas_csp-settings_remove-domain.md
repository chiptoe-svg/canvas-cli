---
title: canvas csp-settings remove-domain
---

## canvas csp-settings remove-domain

Remove a domain from the CSP allowlist

```
canvas csp-settings remove-domain <account-id> [flags]
```

### Options

```
      --domain string   Domain to remove from CSP allowlist
