---
title: canvas quizzes assignment-overrides list
---

## canvas quizzes assignment-overrides list

List quiz assignment overrides

### Synopsis

List assignment overrides for quizzes in a course.
...
```
canvas quizzes assignment-overrides list [flags]
```
