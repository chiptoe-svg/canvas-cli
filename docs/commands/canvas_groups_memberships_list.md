---
title: canvas groups memberships list
---

## canvas groups memberships list

List group membership records

### Synopsis

List all membership records for a group.
...
```
canvas groups memberships list <group-id> [flags]
```
