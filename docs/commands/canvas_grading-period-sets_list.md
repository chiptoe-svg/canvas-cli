---
title: canvas grading-period-sets list
---

## canvas grading-period-sets list

List grading period sets for an account

```
canvas grading-period-sets list <account-id> [flags]
```
