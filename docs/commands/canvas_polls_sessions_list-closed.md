---
title: canvas polls sessions list-closed
---

## canvas polls sessions list-closed

List all closed poll sessions

### Synopsis

List all closed poll sessions across all polls.
...
```
canvas polls sessions list-closed [flags]
```

### Options

```
  -h, --help   help for list-closed
```
