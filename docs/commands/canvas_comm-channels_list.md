---
title: canvas comm-channels list
---

## canvas comm-channels list

List communication channels for a user

### Synopsis

List all communication channels for a specific user.
...
```
canvas comm-channels list [flags]
```
