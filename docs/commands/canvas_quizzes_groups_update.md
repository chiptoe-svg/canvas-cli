---
title: canvas quizzes groups update
---

## canvas quizzes groups update

Update a quiz question group

### Synopsis

Update an existing quiz question group.
...
```
canvas quizzes groups update <group-id> [flags]
```
