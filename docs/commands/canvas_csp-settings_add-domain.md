---
title: canvas csp-settings add-domain
---

## canvas csp-settings add-domain

Add a domain to the CSP allowlist

```
canvas csp-settings add-domain <account-id> [flags]
```

### Options

```
      --domain string   Domain to add to CSP allowlist
  -h, --help            help for add-domain
```
