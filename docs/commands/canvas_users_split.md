---
title: canvas users split
---

## canvas users split

Split a merged user back into separate users

### Synopsis

Split a previously merged user back into separate users. Requires admin privileges.
...
```
canvas users split <user-id> [flags]
```
