---
title: canvas observees remove
---

## canvas observees remove

Remove an observee from a user

### Synopsis

Remove an observee relationship from a user.
...
```
  -h, --help              help for remove
      --observee-id int   Observee user ID (required)
