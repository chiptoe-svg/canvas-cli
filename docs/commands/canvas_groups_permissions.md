---
title: canvas groups permissions
---

## canvas groups permissions

Get group permissions for current user

### Synopsis

Get the permissions the current user has for a group.
...
```
canvas groups permissions <group-id> [flags]
```
...
```
  -h, --help                  help for permissions
      --permissions strings   Permission names to check
```
