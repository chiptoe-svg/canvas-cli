---
title: canvas groups memberships get
---

## canvas groups memberships get

Get a single membership record

### Synopsis

Get a specific membership record by membership ID.
...
```
canvas groups memberships get <group-id> [flags]
```
