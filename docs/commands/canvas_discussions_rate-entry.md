---
title: canvas discussions rate-entry
---

## canvas discussions rate-entry

Rate a discussion entry

### Synopsis

Rate a discussion entry. Rating must be 0 (un-rate) or 1 (like).
...
```
canvas discussions rate-entry <topic-id> <entry-id> [flags]
```
...
```
  ...
  -h, --help            help for rate-entry
      --rating int      Rating value: 0 (un-rate) or 1 (like) (default 1)
```
