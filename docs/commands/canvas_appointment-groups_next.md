---
title: canvas appointment-groups next
---
...
Return the next appointment available to sign up for.
...
```
canvas appointment-groups next [flags]
```

### Options

```
      --group-ids strings   Appointment group IDs to search
