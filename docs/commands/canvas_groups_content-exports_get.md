---
title: canvas groups content-exports get
---

## canvas groups content-exports get

Get a content export for a group

```
canvas groups content-exports get <group-id> [flags]
```

### Options

```
      --export-id int   Export ID (required)
  -h, --help            help for get
```
