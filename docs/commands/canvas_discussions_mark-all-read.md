---
title: canvas discussions mark-all-read
---

## canvas discussions mark-all-read

Mark all discussion topics as read

### Synopsis

Mark all discussion topics in a course or group as read.
...
```
canvas discussions mark-all-read [flags]
```
