---
title: canvas rubric-associations delete-assessment
---

## canvas rubric-associations delete-assessment

Delete a rubric assessment

```
canvas rubric-associations delete-assessment <association-id> [flags]
```

### Options

```
      --assessment-id int   Assessment ID (required)
      --course-id int       Course ID (required)
  -h, --help                help for delete-assessment
```
