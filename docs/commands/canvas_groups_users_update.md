---
title: canvas groups users update
---

## canvas groups users update

Update a user's membership in a group

### Synopsis

Update a specific user's membership state or moderator status.
...
```
canvas groups users update <group-id> [flags]
```
