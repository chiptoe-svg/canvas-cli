---
title: canvas course-settings effective-due-dates
---

## canvas course-settings effective-due-dates

Get effective due dates for all assignments in a course

```
canvas course-settings effective-due-dates [flags]
```
...
```
  ...
  -h, --help            help for effective-due-dates
```
