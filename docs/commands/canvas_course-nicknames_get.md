---
title: canvas course-nicknames get
---

## canvas course-nicknames get

Get the nickname for a course

### Synopsis

Get the nickname set for a specific course.
...
```
canvas course-nicknames get <course-id> [flags]
```
