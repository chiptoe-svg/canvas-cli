---
title: canvas media objects update
---

## canvas media objects update

Update a media object

### Synopsis

Update the title of a media object.
...
```
canvas media objects update <media-id> [flags]
```
...
```
  -h, --help           help for update
      --title string   New title for the media object
```
