---
title: canvas observees observers
---

## canvas observees observers

Manage user observers

### Synopsis

Manage observers for Canvas users.

### Options

```
  -h, --help   help for observers
```
...
* [canvas observees observers list](canvas_observees_observers_list.md)	 - List observers for a user
