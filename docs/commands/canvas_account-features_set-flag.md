---
title: canvas account-features set-flag
---

## canvas account-features set-flag

Set the state of a feature flag for an account

```
canvas account-features set-flag <account-id> <feature> [flags]
```

### Options

```
  -h, --help           help for set-flag
      --state string   Feature state: on, off, allowed, allowed_on
```
