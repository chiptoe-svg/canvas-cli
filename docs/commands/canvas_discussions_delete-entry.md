---
title: canvas discussions delete-entry
---

## canvas discussions delete-entry

Delete a discussion entry

### Synopsis

Delete an existing discussion entry.
...
```
canvas discussions delete-entry <topic-id> <entry-id> [flags]
```
