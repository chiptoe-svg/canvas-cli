---
title: canvas discussions mark-entry-read
---

## canvas discussions mark-entry-read

Mark a discussion entry as read

### Synopsis

Mark a specific discussion entry as read.
...
```
canvas discussions mark-entry-read <topic-id> <entry-id> [flags]
```
...
```
  ...
  -h, --help            help for mark-entry-read
```
