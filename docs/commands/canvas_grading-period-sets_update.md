---
title: canvas grading-period-sets update
---

## canvas grading-period-sets update

Update a grading period set

```
canvas grading-period-sets update <account-id> <id> [flags]
```
...
```
  -h, --help           help for update
      --title string   New title for the grading period set
```
