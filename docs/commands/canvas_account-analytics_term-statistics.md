---
title: canvas account-analytics term-statistics
---

## canvas account-analytics term-statistics

Get statistics for an account term

```
canvas account-analytics term-statistics <account-id> <term-id> [flags]
```

### Options

```
  -h, --help   help for term-statistics
```
