---
title: canvas files reset-verifier
---

## canvas files reset-verifier

Reset the link verifier for a file

### Synopsis

Reset the link verifier for a file. Any existing links using the
...
```
canvas files reset-verifier <file-id> [flags]
```

### Options

```
  -h, --help   help for reset-verifier
```
