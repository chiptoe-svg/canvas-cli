---
title: canvas account-calendars list-for-account
---

## canvas account-calendars list-for-account

List account calendars for a specific account

```
canvas account-calendars list-for-account <account-id> [flags]
```

### Options

```
  -h, --help            help for list-for-account
      --search string   Filter calendars by name
```
