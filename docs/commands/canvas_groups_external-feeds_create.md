---
title: canvas groups external-feeds create
---

## canvas groups external-feeds create

Add an external feed to a group

```
canvas groups external-feeds create <group-id> [flags]
```

### Options

```
      --header string      Header match string
  -h, --help               help for create
      --url string         Feed URL (required)
      --verbosity string   Verbosity (full, truncate, link_only)
```
