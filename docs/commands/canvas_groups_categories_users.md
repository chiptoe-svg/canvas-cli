---
title: canvas groups categories users
---

## canvas groups categories users

List users in a group category

### Synopsis

List users who are enrolled in groups within a category.
...
```
canvas groups categories users <category-id> [flags]
```
