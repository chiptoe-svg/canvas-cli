---
title: canvas account-ext-tools-favorites remove-topnav
---

## canvas account-ext-tools-favorites remove-topnav

Remove an external tool from the top-nav favorites for an account

```
canvas account-ext-tools-favorites remove-topnav <account-id> <tool-id> [flags]
```

### Options

```
  -h, --help   help for remove-topnav
```
