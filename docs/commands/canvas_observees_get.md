---
title: canvas observees get
---

## canvas observees get

Get a specific observee for a user

### Synopsis

Get details of a specific observee for a user.
