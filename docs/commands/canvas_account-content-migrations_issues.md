---
title: canvas account-content-migrations issues
---

## canvas account-content-migrations issues

List migration issues for an account content migration

```
canvas account-content-migrations issues <account-id> <migration-id> [flags]
```
