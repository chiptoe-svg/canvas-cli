---
title: canvas groups external-feeds delete
---

## canvas groups external-feeds delete

Delete an external feed from a group

```
canvas groups external-feeds delete <group-id> [flags]
```

### Options

```
      --feed-id int   External feed ID (required)
