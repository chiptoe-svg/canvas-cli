---
title: canvas auth-providers sso-settings
---

## canvas auth-providers sso-settings

Get SSO settings for an account

```
canvas auth-providers sso-settings <account-id> [flags]
```
