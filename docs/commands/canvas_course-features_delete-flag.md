---
title: canvas course-features delete-flag
---

## canvas course-features delete-flag

Remove a feature flag override for a course

```
canvas course-features delete-flag [flags]
```
