---
title: canvas discussions mark-entries-read
---

## canvas discussions mark-entries-read

Mark all entries in a topic as read

### Synopsis

Mark all entries in a discussion topic as read.
...
```
canvas discussions mark-entries-read <topic-id> [flags]
```
...
```
  ...
  -h, --help            help for mark-entries-read
```
