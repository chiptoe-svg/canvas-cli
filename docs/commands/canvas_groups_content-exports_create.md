---
title: canvas groups content-exports create
---

## canvas groups content-exports create

Start a content export for a group

```
canvas groups content-exports create <group-id> [flags]
```

### Options

```
      --export-type string   Export type e.g. common_cartridge (required)
